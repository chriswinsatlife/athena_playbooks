 ...
 *
 * Defines Zod schemas for playbook content validation.
 * Schemas are exported individually for use in generation scripts.
 */
...
// No section-level audience field - playbooks are always for clients
// The content itself describes what the client does vs what they delegate
...
export const toolSpotlightSchema = z.object({
  tool_slug: z.string().describe('Reference to tool in tools array'),
  context: z.string().describe('Why this tool is relevant here'),
}).describe('Featured tool callout');
